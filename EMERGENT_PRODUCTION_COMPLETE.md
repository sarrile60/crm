...
# CORS Settings
CORS_ALLOWED_ORIGINS=https://solicitor-admin.preview.emergentagent.com,http://localhost:3000
```

### Frontend: `/app/frontend/.env`
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://solicitor-admin.preview.emergentagent.com
...
**URL:** `https://solicitor-admin.preview.emergentagent.com/api/admin/login`
