...
# CORS Settings
CORS_ALLOWED_ORIGINS=https://lawcrm-i18n-1.preview.emergentagent.com,http://localhost:3000
```
...
**URL:** `https://lawcrm-i18n-1.preview.emergentagent.com/api/admin/login`
