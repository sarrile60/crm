...
# CORS Settings
CORS_ALLOWED_ORIGINS=https://legal-hub-27.preview.emergentagent.com,http://localhost:3000
```

### Frontend: `/app/frontend/.env`
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://legal-hub-27.preview.emergentagent.com
...
**URL:** `https://legal-hub-27.preview.emergentagent.com/api/admin/login`
