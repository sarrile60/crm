...
# CORS Settings
CORS_ALLOWED_ORIGINS=https://fervent-mclaren-2.preview.emergentagent.com,http://localhost:3000
```
...
**URL:** `https://fervent-mclaren-2.preview.emergentagent.com/api/admin/login`
