...
# CORS Settings
CORS_ALLOWED_ORIGINS=https://i18n-dashboard-6.preview.emergentagent.com,http://localhost:3000
```
...
**URL:** `https://i18n-dashboard-6.preview.emergentagent.com/api/admin/login`
