...
# CORS Settings
CORS_ALLOWED_ORIGINS=https://crm-workflow-13.preview.emergentagent.com,http://localhost:3000
```

### Frontend: `/app/frontend/.env`
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://crm-workflow-13.preview.emergentagent.com
...
**URL:** `https://crm-workflow-13.preview.emergentagent.com/api/admin/login`
