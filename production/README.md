...
```bash
# Response time test
time curl -s https://deposit-crm.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://deposit-crm.preview.emergentagent.com/`
- **Admin Panel:** `https://deposit-crm.preview.emergentagent.com/admin`
- **API Base:** `https://deposit-crm.preview.emergentagent.com/api`
- **Health Check:** `https://deposit-crm.preview.emergentagent.com/health`
