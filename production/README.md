...
```bash
# Response time test
time curl -s https://law-crm-admin.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://law-crm-admin.preview.emergentagent.com/`
- **Admin Panel:** `https://law-crm-admin.preview.emergentagent.com/admin`
- **API Base:** `https://law-crm-admin.preview.emergentagent.com/api`
- **Health Check:** `https://law-crm-admin.preview.emergentagent.com/health`
