...
```bash
# Response time test
time curl -s https://lawcrm-admin.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://lawcrm-admin.preview.emergentagent.com/`
- **Admin Panel:** `https://lawcrm-admin.preview.emergentagent.com/admin`
- **API Base:** `https://lawcrm-admin.preview.emergentagent.com/api`
- **Health Check:** `https://lawcrm-admin.preview.emergentagent.com/health`
