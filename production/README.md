...
```bash
# Response time test
time curl -s https://lawfirm-ops.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://lawfirm-ops.preview.emergentagent.com/`
- **Admin Panel:** `https://lawfirm-ops.preview.emergentagent.com/admin`
- **API Base:** `https://lawfirm-ops.preview.emergentagent.com/api`
- **Health Check:** `https://lawfirm-ops.preview.emergentagent.com/health`
