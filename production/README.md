...
```bash
# Response time test
time curl -s https://legal-hub-27.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://legal-hub-27.preview.emergentagent.com/`
- **Admin Panel:** `https://legal-hub-27.preview.emergentagent.com/admin`
- **API Base:** `https://legal-hub-27.preview.emergentagent.com/api`
- **Health Check:** `https://legal-hub-27.preview.emergentagent.com/health`
