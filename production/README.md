...
```bash
# Response time test
time curl -s https://solicitor-admin.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://solicitor-admin.preview.emergentagent.com/`
- **Admin Panel:** `https://solicitor-admin.preview.emergentagent.com/admin`
- **API Base:** `https://solicitor-admin.preview.emergentagent.com/api`
- **Health Check:** `https://solicitor-admin.preview.emergentagent.com/health`
