...
```bash
# Response time test
time curl -s https://i18n-dashboard-6.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://i18n-dashboard-6.preview.emergentagent.com/`
- **Admin Panel:** `https://i18n-dashboard-6.preview.emergentagent.com/admin`
- **API Base:** `https://i18n-dashboard-6.preview.emergentagent.com/api`
- **Health Check:** `https://i18n-dashboard-6.preview.emergentagent.com/health`
