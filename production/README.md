...
```bash
# Response time test
time curl -s https://fervent-mclaren-2.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://fervent-mclaren-2.preview.emergentagent.com/`
- **Admin Panel:** `https://fervent-mclaren-2.preview.emergentagent.com/admin`
- **API Base:** `https://fervent-mclaren-2.preview.emergentagent.com/api`
- **Health Check:** `https://fervent-mclaren-2.preview.emergentagent.com/health`
