...
```bash
# Response time test
time curl -s https://leads-ui-upgrade.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://leads-ui-upgrade.preview.emergentagent.com/`
- **Admin Panel:** `https://leads-ui-upgrade.preview.emergentagent.com/admin`
- **API Base:** `https://leads-ui-upgrade.preview.emergentagent.com/api`
- **Health Check:** `https://leads-ui-upgrade.preview.emergentagent.com/health`
