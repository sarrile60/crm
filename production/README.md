...
```bash
# Response time test
time curl -s https://solicitor-suite.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://solicitor-suite.preview.emergentagent.com/`
- **Admin Panel:** `https://solicitor-suite.preview.emergentagent.com/admin`
- **API Base:** `https://solicitor-suite.preview.emergentagent.com/api`
- **Health Check:** `https://solicitor-suite.preview.emergentagent.com/health`
