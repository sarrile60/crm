...
```bash
# Response time test
time curl -s https://lawcrm-i18n.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://lawcrm-i18n.preview.emergentagent.com/`
- **Admin Panel:** `https://lawcrm-i18n.preview.emergentagent.com/admin`
- **API Base:** `https://lawcrm-i18n.preview.emergentagent.com/api`
- **Health Check:** `https://lawcrm-i18n.preview.emergentagent.com/health`
