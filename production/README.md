...
```bash
# Response time test
time curl -s https://deposit-crm-1.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://deposit-crm-1.preview.emergentagent.com/`
- **Admin Panel:** `https://deposit-crm-1.preview.emergentagent.com/admin`
- **API Base:** `https://deposit-crm-1.preview.emergentagent.com/api`
- **Health Check:** `https://deposit-crm-1.preview.emergentagent.com/health`
