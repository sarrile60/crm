...
```bash
# Response time test
time curl -s https://profit-pulse-136.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://profit-pulse-136.preview.emergentagent.com/`
- **Admin Panel:** `https://profit-pulse-136.preview.emergentagent.com/admin`
- **API Base:** `https://profit-pulse-136.preview.emergentagent.com/api`
- **Health Check:** `https://profit-pulse-136.preview.emergentagent.com/health`
