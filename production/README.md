...
```bash
# Response time test
time curl -s https://finance-suite-9.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://finance-suite-9.preview.emergentagent.com/`
- **Admin Panel:** `https://finance-suite-9.preview.emergentagent.com/admin`
- **API Base:** `https://finance-suite-9.preview.emergentagent.com/api`
- **Health Check:** `https://finance-suite-9.preview.emergentagent.com/health`
