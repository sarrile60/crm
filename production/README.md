...
```bash
# Response time test
time curl -s https://leadhub-32.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://leadhub-32.preview.emergentagent.com/`
- **Admin Panel:** `https://leadhub-32.preview.emergentagent.com/admin`
- **API Base:** `https://leadhub-32.preview.emergentagent.com/api`
- **Health Check:** `https://leadhub-32.preview.emergentagent.com/health`
