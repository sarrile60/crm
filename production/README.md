...
```bash
# Response time test
time curl -s https://crm-workflow-13.preview.emergentagent.com/health > /dev/null
...
### Important URLs
- **Public Site:** `https://crm-workflow-13.preview.emergentagent.com/`
- **Admin Panel:** `https://crm-workflow-13.preview.emergentagent.com/admin`
- **API Base:** `https://crm-workflow-13.preview.emergentagent.com/api`
- **Health Check:** `https://crm-workflow-13.preview.emergentagent.com/health`
