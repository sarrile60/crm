...
**System:** https://deposit-manager-9.preview.emergentagent.com
...
Risk Level: CRITICAL (10/10)
Accessible Files:
✓ https://deposit-manager-9.preview.emergentagent.com/backend/.env
✓ https://deposit-manager-9.preview.emergentagent.com/backend/server.py
✓ https://deposit-manager-9.preview.emergentagent.com/backend/auth_utils.py
✓ https://deposit-manager-9.preview.emergentagent.com/backend/crm_routes.py
...
```
URL: https://deposit-manager-9.preview.emergentagent.com/
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://deposit-manager-9.preview.emergentagent.com",
