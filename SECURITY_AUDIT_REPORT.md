...
**System:** https://lawfirm-localize.preview.emergentagent.com
...
Risk Level: CRITICAL (10/10)
Accessible Files:
✓ https://lawfirm-localize.preview.emergentagent.com/backend/.env
✓ https://lawfirm-localize.preview.emergentagent.com/backend/server.py
✓ https://lawfirm-localize.preview.emergentagent.com/backend/auth_utils.py
✓ https://lawfirm-localize.preview.emergentagent.com/backend/crm_routes.py
...
```
URL: https://lawfirm-localize.preview.emergentagent.com/
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://lawfirm-localize.preview.emergentagent.com",
