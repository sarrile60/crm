            ...
            <div>
              ...
              <div className="flex gap-2 items-center">
                ...
                <div className="flex flex-col">
                  <button 
                    type="button"
                    onClick={() => updateSetting('session_start_minute', Math.min(59, settings.session_start_minute + 5))}
                    className="px-3 py-1 bg-gray-100 hover:bg-gray-200 border border-gray-300 text-xs"
                  >▲</button>
                  <Input
                    type="text"
                  ...
                  <button 
                    type="button"
                    onClick={() => updateSetting('session_start_minute', Math.max(0, settings.session_start_minute - 5))}
                    className="px-3 py-1 bg-gray-100 hover:bg-gray-200 border border-gray-300 text-xs"
                  >▼</button>
                </div>
              </div>
